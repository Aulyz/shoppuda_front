    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(
                        max_length=20, unique=True, verbose_name="브랜드 코드"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "short_description",
                    models.TextField(
                        blank=True, max_length=500, verbose_name="간단 설명"
                    ),
                ),
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0, verbose_name="최소 재고 수준"
                    ),
                ),
                (
                    "max_stock_level",
                    models.PositiveIntegerField(
                        default=1000, verbose_name="최대 재고 수준"
                    ),
                ),
                (
                    "weight",
                ...
                (
                    "tags",
                    models.TextField(
                        blank=True, help_text="쉼표로 구분", verbose_name="태그"
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(upload_to="products/", verbose_name="이미지"),
                ),
                (
                    "alt_text",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reason",
                    models.CharField(
                        blank=True, max_length=200, verbose_name="변경 사유"
                    ),
                ),
                (
                    "created_at",
