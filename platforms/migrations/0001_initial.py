    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platform_type', models.CharField(choices=[('SMARTSTORE', '스마트스토어'), ('COUPANG', '쿠팡'), ('GMARKET', 'G마켓'), ('AUCTION', '옥션'), ('11ST', '11번가'), ('TMON', '티몬'), ('WMP', '위메프'), ('SHOPIFY', 'Shopify'), ('AMAZON', 'Amazon'), ('OTHER', '기타')], max_length=20, verbose_name='플랫폼 유형')),
                ('api_key', models.CharField(blank=True, max_length=500, null=True, verbose_name='API 키')),
                ('api_secret', models.CharField(blank=True, max_length=500, null=True, verbose_name='API 시크릿')),
                ...
                ('last_sync_status', models.CharField(blank=True, choices=[('success', '성공'), ('error', '오류'), ('running', '진행중')], max_length=20, null=True, verbose_name='마지막 동기화 상태')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platform_sku', models.CharField(blank=True, max_length=100, verbose_name='플랫폼 SKU')),
                ('platform_price', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='플랫폼 판매가')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='생성일시')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='수정일시')),
                ('platform', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='platforms.platform', verbose_name='플랫폼')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='platform_products', to='products.product', verbose_name='상품')),
            ],
            options={
                'verbose_name': '플랫폼 상품',
                'verbose_name_plural': '플랫폼 상품',
                'indexes': [models.Index(fields=['platform', 'is_active'], name='platforms_p_platfor_f74993_idx'), models.Index(fields=['product', 'platform'], name='platforms_p_product_1573f9_idx')],
